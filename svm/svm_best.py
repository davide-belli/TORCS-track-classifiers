...
path = "./experiment/"+str(i)+"/"
if not os.path.exists(path):
    os.makedirs(path)

shuffle(road_files)
shuffle(dirt_files)
this_road = ["cg_track3_1","alpine2_1","brondehach_1","etrack3_1","etrack4_1"]
this_dirt = ["manual_2017-11-29_17-46-16","manual_2017-11-29_17-45-28","manual_2017-11-29_17-48-05","manual_2017-11-29_17-45-48","manual_2017-11-29_17-47-57"]
